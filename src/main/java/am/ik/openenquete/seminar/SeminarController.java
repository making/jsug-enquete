...
public class SeminarController {
	...
	public SeminarController(SeminarRepository seminarRepository,
			ResponseForSeminarRepository responseForSeminarRepository, ContextUsername contextUsername,
	...
	String list(@PathVariable UUID seminarId, Model model, UriComponentsBuilder uriComponentsBuilder) {
		...
		Optional<ResponseForSeminar> response = responseForSeminarRepository
			.findBySeminar_SeminarIdAndUsername(seminarId, username);
